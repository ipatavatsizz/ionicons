...
val Ionicons.Filled.LogoGitlab: ImageVector
  get() {
    if (_LogoGitlab != null) {
      return _LogoGitlab!!
    }
    _LogoGitlab = ImageVector.Builder(
      name = "Filled.LogoGitlab",
      defaultWidth = 512.dp,
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        curveTo(247.35f, 486.55f, 251.63f, 488f, 256.03f, 488f)
        curveTo(260.44f, 488f, 264.72f, 486.55f, 268.23f, 483.88f)
