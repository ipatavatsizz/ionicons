...
val Ionicons.Logo.AppleAppstore: ImageVector
  get() {
    if (_AppleAppstore != null) {
      return _AppleAppstore!!
    }
    _AppleAppstore = ImageVector.Builder(
      name = "Logo.AppleAppstore",
...
private var _AppleAppstore: ImageVector? = null
