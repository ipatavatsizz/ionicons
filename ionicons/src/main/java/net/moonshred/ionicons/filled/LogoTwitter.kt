...
val Ionicons.Filled.LogoTwitter: ImageVector
  get() {
    if (_LogoTwitter != null) {
      return _LogoTwitter!!
    }
    _LogoTwitter = ImageVector.Builder(
      name = "Filled.LogoTwitter",
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        curveTo(36f, 164f, 53.53f, 193.7f, 80f, 211.1f)
        ...
        arcTo(203f, 203f, 0f, isMoreThanHalf = false, isPositiveArc = true, 16f, 404.2f)
