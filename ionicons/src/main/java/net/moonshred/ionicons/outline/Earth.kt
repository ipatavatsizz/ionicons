  ...
  get() {
    ...
    _EarthOutline = ImageVector.Builder(
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        curveToRelative(-7.43f, -5.18f, -12f, -12.71f, -21.33f, -15f)
        curveToRelative(-8.15f, -2f, -16.5f, 0.08f, -24.55f, 1.47f)
        curveToRelative(-9.15f, 1.58f, -20f, 2.29f, -26.94f, 9.22f)
        curveToRelative(-6.71f, 6.67f, -10.26f, 15.62f, -17.4f, 22.33f)
        curveToRelative(-13.81f, 13f, -19.64f, 27.19f, -10.7f, 45.57f)
        curveToRelative(8.6f, 17.67f, 26.59f, 27.26f, 46f, 26f)
        ...
        lineToRelative(15f, -21.16f)
        curveToRelative(1.85f, -2.62f, 5.72f, -6.29f, 6.64f, -9.38f)
        curveToRelative(1.63f, -5.47f, -1.58f, -14.87f, -1.95f, -21f)
        ...
        curveToRelative(-11.76f, -12.75f, -29f, -15.81f, -45.47f, -13.22f)
        ...
        reflectiveCurveToRelative(17f, -5.18f, 21f, -3.95f)
        reflectiveCurveToRelative(8.17f, 7f, 11.64f, 9.56f)
        arcToRelative(
          49.89f,
          49.89f,
          0f,
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        curveToRelative(8f, -6.14f, 14.84f, -10.58f, 13.56f, -21.61f)
        curveToRelative(-0.76f, -6.48f, -4.31f, -9.41f, -1f, -15.86f)
        curveToRelative(2.51f, -4.91f, 9.4f, -9.34f, 13.89f, -12.27f)
        curveToRelative(11.59f, -7.56f, 49.65f, -7f, 34.1f, -28.16f)
        curveToRelative(-4.57f, -6.21f, -13f, -17.31f, -21f, -18.83f)
        curveToRelative(-10f, -1.89f, -14.44f, 9.27f, -21.41f, 14.19f)
        curveToRelative(-7.2f, 5.09f, -21.22f, 10.87f, -28.43f, 3f)
        curveToRelative(-9.7f, -10.59f, 6.43f, -14.07f, 10f, -21.46f)
        reflectiveCurveTo(176.34f, 70.33f, 170f, 66.79f)
        ...
        curveToRelative(0.42f, 10f, -1.14f, 15.12f, -7.68f, 22.15f)
        curveToRelative(-2.83f, 3f, -4.83f, 7.26f, -7.71f, 10.07f)
        curveToRelative(-3.53f, 3.43f, -2.22f, 2.38f, -7.73f, 3.32f)
        curveToRelative(-10.36f, 1.75f, -19.18f, 4.45f, -29.19f, 7.21f)
        curveTo(95.34f, 199.94f, 93.8f, 172.69f, 86.2f, 162f)
        lineToRelative(-25f, 20.19f)
        curveToRelative(-0.27f, 3.31f, 4.1f, 9.4f, 5.29f, 13f)
        curveTo(73.32f, 215.76f, 87.1f, 231.67f, 96f, 251.35f)
        curveToRelative(9.37f, 20.84f, 34.53f, 15.06f, 45.64f, 33.32f)
        curveToRelative(9.86f, 16.2f, -0.67f, 36.71f, 6.71f, 53.67f)
        curveToRelative(5.36f, 12.31f, 18f, 15f, 26.72f, 24f)
        ...
        curveToRelative(4.68f, -3.84f, 3.43f, -15.66f, 4.24f, -21f)
        curveToRelative(2.43f, -15.9f, 10.39f, -31.45f, 21.13f, -43.35f)
        curveToRelative(10.61f, -11.74f, 25.15f, -19.69f, 34.11f, -33f)
        curveTo(288.44f, 349f, 291.07f, 331.49f, 287.45f, 316.3f)
        close()
        moveTo(254.06f, 342.62f)
        curveToRelative(-6f, 10.71f, -19.36f, 17.88f, -27.95f, 26.39f)
        curveToRelative(-2.33f, 2.31f, -7.29f, 10.31f, -10.21f, 8.58f)
        curveToRelative(-2.09f, -1.24f, -2.8f, -11.62f, -3.57f, -14f)
        arcToRelative(
          61.17f,
          61.17f,
          0f,
        ...
        curveToRelative(-2f, -3.53f, -0.2f, -11.86f, -0.13f, -15.7f)
        curveToRelative(0.11f, -5.6f, -2.44f, -14.91f, -1.06f, -20f)
        curveToRelative(1.6f, -5.87f, -1.48f, -2.33f, 3.77f, -3.49f)
        curveToRelative(2.77f, -0.62f, 14.21f, 1.39f, 17.66f, 2.11f)
        curveToRelative(5.48f, 1.14f, 8.5f, 4.55f, 12.82f, 8f)
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        curveToRelative(6.69f, 0.45f, 13f, -3.17f, 18.84f, 1.38f)
        curveToRelative(6.48f, 5f, 11.15f, 11.33f, 19.75f, 12.89f)
        curveToRelative(8.32f, 1.51f, 17.13f, -3.35f, 19.19f, -11.86f)
        curveToRelative(2f, -8.11f, -2.31f, -16.93f, -2.57f, -25.07f)
        curveToRelative(0f, -1.13f, 0.61f, -6.15f, -0.17f, -7f)
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        curveToRelative(8.49f, 0f, 17.11f, -3.8f, 14.37f, -13.62f)
        curveToRelative(-2.3f, -8.23f, -6.22f, -17.16f, -15.76f, -12.72f)
        curveToRelative(-6.07f, 2.82f, -14.67f, 10f, -15.38f, 17.12f)
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        arcToRelative(15.4f, 15.4f, 0f, isMoreThanHalf = false, isPositiveArc = true, 10.82f, 4.41f)
        curveToRelative(3.8f, 3.93f, 3.05f, 7.62f, 3.86f, 12.54f)
        curveToRelative(1.81f, 11.05f, 13.66f, 0.63f, 16.75f, -3.65f)
        curveToRelative(2f, -2.79f, 4.71f, -6.93f, 3.8f, -10.56f)
        curveToRelative(-0.84f, -3.39f, -4.8f, -7f, -6.56f, -10.11f)
        curveToRelative(-5.14f, -9f, -9.37f, -19.47f, -17.07f, -26.74f)
        curveToRelative(-7.41f, -7f, -16.52f, -6.19f, -23.55f, 1.08f)
        curveToRelative(-5.76f, 6f, -12.45f, 10.75f, -16.39f, 18.05f)
        curveToRelative(-2.78f, 5.13f, -5.91f, 7.58f, -11.54f, 8.91f)
        curveToRelative(-3.1f, 0.73f, -6.64f, 1f, -9.24f, 3.08f)
