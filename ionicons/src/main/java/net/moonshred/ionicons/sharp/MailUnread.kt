...
val Ionicons.Sharp.MailUnread: ImageVector
  get() {
    if (_MailUnreadSharp != null) {
      return _MailUnreadSharp!!
    }
    _MailUnreadSharp = ImageVector.Builder(
      name = "Sharp.MailUnreadSharp",
      ...
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        curveToRelative(0f, 0.36f, -0.06f, 0.72f, -0.08f, 1.09f)
        curveToRelative(-0.06f, 1.13f, -0.09f, 2.27f, -0.09f, 3.41f)
        verticalLineToRelative(0f)
        curveToRelative(0f, 1f, 0f, 2f, 0.07f, 2.94f)
        lineToRelative(0f, 0.62f)
        ...
        curveToRelative(0f, 0.15f, 0f, 0.31f, 0.07f, 0.46f)
        ...
        curveToRelative(1f, 0f, 1.94f, 0.07f, 2.93f, 0.07f)
        horizontalLineToRelative(0f)
        curveToRelative(1.15f, 0f, 2.29f, 0f, 3.43f, -0.09f)
        lineToRelative(1.09f, -0.09f)
        curveToRelative(0.77f, 0f, 1.54f, -0.11f, 2.3f, -0.19f)
        curveToRelative(0.42f, 0f, 0.83f, -0.1f, 1.25f, -0.16f)
        curveToRelative(0.7f, -0.08f, 1.41f, -0.17f, 2.1f, -0.28f)
        lineToRelative(1.27f, -0.23f)
        curveToRelative(0.68f, -0.12f, 1.36f, -0.25f, 2f, -0.39f)
        lineToRelative(1.24f, -0.29f)
        curveToRelative(0.67f, -0.16f, 1.35f, -0.32f, 2f, -0.51f)
        ...
        curveToRelative(0.91f, -0.48f, 1.8f, -1f, 2.68f, -1.5f)
        ...
        curveTo(374.9f, 99.34f, 374.48f, 100.17f, 374.09f, 101f)
        close()
      }
      path(fill = SolidColor(Color(0xFF000000))) {
        ...
        arcTo(95.81f, 95.81f, 0f, isMoreThanHalf = false, isPositiveArc = true, 349f, 80f)
