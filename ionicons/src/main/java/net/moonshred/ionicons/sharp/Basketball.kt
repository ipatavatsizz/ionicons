...
val Ionicons.Sharp.Basketball: ImageVector
  get() {
    if (_BasketballSharp != null) {
      return _BasketballSharp!!
    }
    _BasketballSharp = ImageVector.Builder(
      name = "Sharp.BasketballSharp",
      defaultWidth = 512.dp,
...
private var _BasketballSharp: ImageVector? = null
