...
val Ionicons.Sharp.Calendar: ImageVector
  get() {
    if (_CalendarSharp != null) {
      return _CalendarSharp!!
    }
    _CalendarSharp = ImageVector.Builder(
      name = "Sharp.CalendarSharp",
      defaultWidth = 512.dp,
...
private var _CalendarSharp: ImageVector? = null
